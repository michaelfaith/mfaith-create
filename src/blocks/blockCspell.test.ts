    ...
    expect(creation).toMatchInlineSnapshot(`
      {
        ...
        "scripts": [
          {
            "commands": [
              "node path/to/cspell-populate-words/bin/index.mjs --words "access" --words "public" --words "contact" --words "email" --words "github@email.com" --words "url" --words "http://contact.url" --words "description" --words "Test description" --words "devExports" --words "directory" --words "." --words "documentation" --words "readme" --words "usage" --words "Test usage." --words "emoji" --words "✨" --words "node" --words "supported" --words "^24.15.0 || >=26.0.0" --words "pinned" --words "24.19.0" --words "owner" --words "test-owner" --words "packageName" --words "test-package-name" --words "preset" --words "minimal" --words "repository" --words "test-repository" --words "title" --words "Test Title"",
            ],
            "phase": 3,
          },
        ],
