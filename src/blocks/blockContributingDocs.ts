...
Please do [report an issue](https://github.com/${options.owner}/${options.repository}/issues/new/choose) if there are any bugs, documentation improvements, or general enhancements you'd like to see in the repository!
...
With the exception of very small typos, all changes to this repository generally need to correspond to an [unassigned open issue marked as \`status: accepting prs\`](https://github.com/${options.owner}/${options.repository}/issues?q=is%3Aissue+is%3Aopen+label%3A%22status%3A+accepting+prs%22+no%3Aassignee+).
