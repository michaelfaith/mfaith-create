...
| `--contact`     | `string`   | Email address to be listed as the point of contact in docs and packages (e.g. `example@michael.faith`)              | Yours from `gh`, `git config`, or `npm whoami`                                                 |
| `--devExports`  | `boolean`  | Whether or not to generate dev exports and use `publishConfig` for exports and bin entries                          | `false`                                                                                        |
