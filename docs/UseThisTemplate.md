...
As an alternative to [creating with `pnpm create @mfaith`](./Setup.md), the [_Use this template_](https://github.com/michaelfaith/mfaith-create/generate) button on GitHub can be used to quickly create a new repository from the template.
